...
Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. And if she hasn’t been rewritten, then they are still using her.','educulture')));?></p>
			...
			<div class="col-md-6 wrap-about py-5 pr-md-4 ftco-animate img-fluid" id="educulture-about-featured-image">
				<div>
					<?php 
				$about_featured_image= get_theme_mod("educulture_about_featured_image");
...
<section class="ftco-section testimony-section bg-light">
	<div class="row justify-content-center mb-5 pb-2 mt-5">
		<div class="col-md-10 offset-md-1 text-center heading-section ftco-animate our-history">
			<h2 class="mb-4" id="educulture-history-heading"><?php echo esc_html(get_theme_mod('educulture_about_history_heading',__('Our History','educulture')));?></h2>
			<hr class="about-underline">
		</div>
	</div>
	<div class="row ftco-animate justify-content-center">
		<div class="col-md-10 offset-md-1 text-justify">
			<p id="educulture-history-description"><?php echo wp_kses_post(get_theme_mod('educulture_about_history_description',__('On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word.
Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. And if she hasn’t been rewritten, then they are still using her.','educulture')));?></p>
		</div>
	</div>
	<div class="row justify-content-center mb-5 pb-2 mt-5">
		<div class="col-md-10 offset-md-1 text-center heading-section ftco-animate our-history">
			<h2 class="mb-4" id="educulture-vision-heading"><?php echo esc_html(get_theme_mod('educulture_about_vision_heading',__('Our Vision','educulture')));?></h2>
			<hr class="about-underline">
		</div>
	</div>
	<div class="row ftco-animate justify-content-center">
		<div class="col-md-10 offset-md-1 text-justify">
			<p id="educulture-vision-description"><?php echo wp_kses_post(get_theme_mod('educulture_about_vision_description',__('On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word.
Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. And if she hasn’t been rewritten, then they are still using her.','educulture')));?></p>
		</div>
	</div>
