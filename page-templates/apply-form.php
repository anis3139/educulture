...
<section id="educulture-apply-image" class="ftco-section ftco-consult ftco-no-pt ftco-no-pb mt-5 mb-5" style="background-image: url(<?php echo esc_url($educulture_apply_image_id);?>);" data-stellar-background-ratio="0.5">
